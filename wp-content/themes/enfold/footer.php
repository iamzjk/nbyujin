	...
	<?php   } //endif nofooterwidgets ?>
			...
			//copyright
			$copyright = do_shortcode( avia_get_option('copyright', " ".__('版权所有','avia_framework')." &copy; " .date('Y')." <a href='".home_url('/')."'>".get_bloginfo('name')."</a>") );
			...
			?>
				...
				<footer class='container_wrap socket_color' id='socket' <?php avia_markup_helper(array('context' => 'footer')); ?>>
                    <div class='container'>
						...
						<span class='copyright'><?php echo $copyright . $kriesi_at_backlink; ?></span><a href="http://www.miitbeian.gov.cn/" rel="external nofollow" target="_blank"><span class='copyright' style='float: right'>浙ICP备18002112号-1</span></a>
